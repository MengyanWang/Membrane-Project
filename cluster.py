...
qw=np.loadtxt('qw.dat')
# qw=np.loadtxt('qo.dat')
...
T=sns.clustermap(qw,col_linkage=row_linkage,row_linkage=row_linkage, annot=True)
plt.savefig('cluster_qw_annot.png')
